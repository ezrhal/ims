...
namespace IMS.Client.Pages
{
	public partial class MedalTally
	{
        ...
        private string label = "Elementary";
        ...
        protected override async Task OnInitializedAsync()
        {
            ...
            // var rnkstr = "";
            //
            // foreach (var totalm in medalTallys)
            //     totalm.totalmedal = Convert.ToInt32(totalm.Gold) + Convert.ToInt32(totalm.Silver) +
            //                         Convert.ToInt32(totalm.Bronze);
            //
            // var SortedList = medalTallys.OrderByDescending(o => o.totalmedal).ToList();
            //
            // foreach (var rnk in SortedList)
            // {
            //     if (rank == 1)
            ...
            //     }
            //
            //     rnk.Province_id = "image/" + rnk.Province_id + ".png";
            //     rnk.rank = rnkstr;
            //     rank++;
            // }
            //
            // for (var i = 0; i < 6; i++) firsthalf.Add(SortedList[i]);
            //
            // for (var i = 6; i < 12; i++) secondhalf.Add(SortedList[i]);
            //
