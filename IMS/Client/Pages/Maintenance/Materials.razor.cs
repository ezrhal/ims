...
namespace IMS.Client.Pages.Maintenance
{
	partial class Materials
	{
        ...
        {
            items = await httpClient.GetFromJsonAsync<List<ItemModel>>("maintenance/getitemsbytype?typeid=" + typeid);
        ...
        public async Task NewMaterial()
        {
            ...
            var result = await DialogService.OpenAsync<AddMaterials>("Add new " + typelabel,
